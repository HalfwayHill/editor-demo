<template>
  <div class="attr-list">
    <el-form>
      <el-form-item v-for="(key, index) in styleKeys" :key="index" :label="attribute.map[key]">
      ...
      <el-form-item label="内容" v-if="curComponent && curComponent.propValue && !attribute.excludes.includes(curComponent.component)">
